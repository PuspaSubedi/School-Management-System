                  ...
                  <div class="panel-body">
                     ...
                     <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-4">
                           <button type="submit" name="save" class="btn btn-success" style="border-radius:0%">Change
                              Password</button>
                        </div>
                     </div>
   ...
   $("#signupForm1").validate({
      ...
      errorPlacement: function(error, element) {
         ...
         if (!element.next("span")[0]) {
            $("<span class='glyphicon glyphicon-remove form-control-feedback'></span>").insertAfter(
               element);
         }
      },
