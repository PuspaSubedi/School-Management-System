...
<head>
   ...
   <!--CUSTOM BASIC STYLES-->
   <link href="css/basic.css?v=1.0" rel="stylesheet" />
   <!--CUSTOM MAIN STYLES-->
...
<div id="page-wrapper">
   <div id="page-inner">
      <div class="row">
         <div class="col-md-12">
            <h1 class="page-head-line">Manage Fees
         ...
         <div class="col-md-12">
            <fieldset class="scheduler-border">
               ...
               <form class="form-inline" role="form" id="searchform">
                  ...
                  <button type="button" class="btn btn-success btn-sm" style="border-radius:0%" id="find"> Filter
                  </button>
                  <button type="reset" class="btn btn-danger btn-sm" style="border-radius:0%" id="clear"> Reset
                  </button>
               </form>
            </fieldset>
      ...
      $(document).ready(function() {
         ...
         */
         ...
         function mydatatable() {
            ...
            $("#subjectresult").html(
               '<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Fees</th><th>Balance</th><th>Grade</th><th>DOJ</th><th>Action</th></tr></thead><tbody></tbody></table>'
            );
